 ...
 */
if(!isset($_POST['oldIdProd']) || !isset($_POST['idProd']) || !isset($_POST['libProd']) || !isset($_POST['prixUni']) || !isset($_POST['categorie'])) exit;
 ...
 */
DB::getInstance()->updateProduit($_POST['oldIdProd'], $Prod);
